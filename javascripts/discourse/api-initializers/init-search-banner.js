        ...
        panelContents() {
            ...
            if (formFactor === "widget") {
                ...
                if (searchInput && searchInput.value) {
                    ...
                    document.querySelector(".search-widget .clear-search")?.classList.add("show-clear-search");
                } else {
                    document.querySelector(".search-widget .search-icon")?.classList.remove("hide-search-icon");
                    document.querySelector(".search-widget .clear-search")?.classList.remove("show-clear-search");
                }
            }
